...
Additionally, I contributed to the frontend development in React/Next.js, focusing on implementing responsive UI components and integrating with the backend APIs.`,
...
- Report generation with 300+ tables and charts, visualizing the collected data
...
The application was built with Django for the backend, utilizing PostgreSQL for data storage. The frontend was implemented using vanilla JavaScript and CSS, focusing on performance and user experience.`,
    summary: "Developed a comprehensive HR data collection system, replacing Excel spreadsheets, consisting of multiple forms with **5000+ inputs**, with a web-based interface featuring **multi-page forms**, **data validation**, and **extensive reporting capabilities**, involving **300+ tables and charts**. Built with **Django** and **vanilla JavaScript**.",
    skills: [
      { name: "Django" },
      { name: "Python" },
      { name: "PostgreSQL" },
